      ...
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <input type="text" id="username" name="username" className="mt-1 text-gray-700 block w-full h-8 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
          </div>
          <div>
